...
urlpatterns = [
    ...
    path(
        "tricks/<slug:slug>/", views.KendamaTrickDetail.as_view(), name="detail-trick"
    ),
    path("tricks/create", views.KendamaTrickCreate.as_view(), name="create-trick"),
    path(
        "tricks/<slug:slug>/update",
        views.KendamaTrickUpdate.as_view(),
        name="update-trick",
    ),
    path(
        "tricks/<slug:slug>/delete",
        views.KendamaTrickDelete.as_view(),
        name="delete-trick",
    ),
    # Combos
    ...
    path(
        "combos/create-trick",
        views.create_trick_from_modal,
        name="create-trick-from-modal",
    ),
    # Common
    path(
    ...
    path("frequency-history", views.frequency_history, name="frequency_history"),
    # Ladders
    ...
    path(
        "ladders/<slug:slug>/update", views.LadderUpdate.as_view(), name="update-ladder"
    ),
    path(
        "ladders/<slug:slug>/delete", views.LadderDelete.as_view(), name="delete-ladder"
    ),
    # Kendamas
    ...
    path(
        "test/",
        TemplateView.as_view(template_name="kendama/base.html"),
        name="test-page",
    ),
]
