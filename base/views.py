...
class UserDetailView(DetailView):
    ...
    def get_queryset(self):
        ...
        return queryset.prefetch_related(
            "profil__joueur__partie_set__partiejoueur_set__joueur",
            "profil__joueur__partie_set__jeu",
            "profil__musiques_crees__artiste",
            "profil__musiques_crees__featuring",
            "profil__musiques_crees__remixed_by",
        )
...
def change_password(request):
    ...
    return render(request, "base/profil/change_password.html", {"form": form})
...
def update_profil(request, username):
    ...
    return render(
        request, "base/profil/update_profil.html", {"profil": profil, "form": form}
    )
